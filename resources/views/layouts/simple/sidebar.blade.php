				...
				<ul class="sidebar-links" id="simple-bar">
					...
					<li class="sidebar-list">
						...
						<ul class="sidebar-submenu" style="display: {{ request()->route()->getPrefix() == '/project' ? 'block;' : 'none;' }}">
		                    ...
		                    <li><a href="{{route('logo')}}" class="{{ Route::currentRouteName()=='logo' ? 'active' : '' }}">{{ trans('Logo Management') }}</a></li>
		                </ul>
					</li>
                    ...
                    <li class="sidebar-list">
						<a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/blog' ? 'active' : '' }}" href="#"><i data-feather="image"></i><span>{{ trans('lang.Blog') }}</span>
					...
					<li class="sidebar-list">
						...
						<ul class="sidebar-submenu" style="display: {{ request()->route()->getPrefix() == '/general' ? 'block;' : 'none;' }}">
		                    ...
		                    <li><a href="{{route('congfigration')}}" class="{{ Route::currentRouteName()=='congfigration' ? 'active' : '' }}">{{ trans('Email Setting') }}</a></li>
		                </ul>
					</li>
                    {{-- ==== I N Q U I R Y WORK ===  --}}
