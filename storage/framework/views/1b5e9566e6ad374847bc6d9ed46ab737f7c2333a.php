                                    ...
                                    <tbody class="f-w-500">
                                            ...
                                            <td>
                                                <div class="media">
                                                    <img class="img-fluid m-r-15 rounded-circle"
                                                        src="<?php echo e(asset('assets/images/dashboard-2/product-1.png')); ?>" alt="">
                                                    <div class="media-body">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media">
                                                    <img class="img-fluid m-r-15 rounded-circle"
                                                        src="<?php echo e(asset('assets/images/dashboard-2/product-3.png')); ?>" alt="">
                                                    <div class="media-body">
                                                        <span>Tree Pot</span>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media">
                                                    <img class="img-fluid m-r-15 rounded-circle"
                                                        src="<?php echo e(asset('assets/images/dashboard-2/product-4.png')); ?>" alt="">
                                                    <div class="media-body">
                                                        <span>Bag</span>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media">
                                                    <img class="img-fluid m-r-15 rounded-circle"
                                                        src="<?php echo e(asset('assets/images/dashboard-2/product-5.png')); ?>" alt="">
                                                    <div class="media-body">
                                                        <span>Wtach</span>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media">
                                                    <img class="img-fluid m-r-15 rounded-circle"
                                                        src="<?php echo e(asset('assets/images/dashboard-2/product-6.png')); ?>" alt="">
                                                    <div class="media-body">
                                                        <span>T-shirt</span>
                                ...
                                <div class="offer-slider">
                                    <div class="carousel slide" id="carouselExampleCaptions" data-bs-ride="carousel">
                                                ...
                                                <div class="selling-slide row">
                                                    <div class="col-xl-4 col-md-6">
                                                        <div class="d-flex">
                                                            <div class="left-content">
                                                                ...
                                                                <span class="badge badge-white rounded-pill">78%
                                                                    offer</span><span
                                                                    class="badge badge-dotted rounded-pill ms-2">Coupon
                                                                    Code : 12345</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-4 col-md-12">
                                                        <div class="center-img"><img class="img-fluid"
                                                                src="<?php echo e(asset('assets/images/dashboard-2/offer-shoes-3.png')); ?>"
                                                                alt="..."></div>
                                                    </div>
                                                    <div class="col-xl-4 col-md-6">
                                                        <div class="d-flex">
                                                    ...
                                                    <div class="col-xl-4 col-md-6">
                                                        <div class="d-flex">
                                                            <div class="left-content">
                                                                ...
                                                                <h4 class="f-w-600">Best Selling Product</h4>
                                                                <span class="badge badge-white rounded-pill">50%
                                                                    offer</span><span
                                                                    class="badge badge-dotted rounded-pill ms-2">Coupon
                                                                    Code : 21546</span>
                                                            </div>
                                        ...
                                        <a class="carousel-control-prev" href="#carouselExampleCaptions" role="button"
                                            ...
                                            href="#carouselExampleCaptions" role="button" data-bs-slide="next"><span
                                            ...
                                            <table class="table table-bordernone">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="d-inline-block align-middle">
                                                                <img class="img-40 m-r-15 rounded-circle align-top"
                                                                    src="<?php echo e(asset('assets/images/avtar/7.jpg')); ?>" alt="">
                                                        ...
                                                        <td class="text-end"><i class="fa fa-check-circle"></i>Done
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <div class="d-inline-block align-middle">
                                                                <img class="img-40 m-r-15 rounded-circle align-top"
                                                                    src="<?php echo e(asset('assets/images/avtar/4.jpg')); ?>" alt="">
                                                                <div class="status-circle bg-primary"></div>
                                                                <div class="d-inline-block">
                                                        ...
                                                        <td class="text-end"><i
                                                                class="fa fa-check-circle"></i>Pending</td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <div class="d-inline-block align-middle">
                                                                <img class="img-40 m-r-15 rounded-circle align-top"
                                                                    src="<?php echo e(asset('assets/images/avtar/16.jpg')); ?>" alt="">
                                                                <div class="status-circle bg-primary"></div>
                                                                <div class="d-inline-block">
                                                                    <span>loain deo</span>
                                                                    <p class="font-roboto">2020</p>
                                                        ...
                                                        <td class="text-end"><i
                                                                class="fa fa-check-circle"></i>Success</td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <div class="d-inline-block align-middle">
                                                                <img class="img-40 m-r-15 rounded-circle align-top"
                                                                    src="<?php echo e(asset('assets/images/avtar/11.jpg')); ?>" alt="">
                                                                <div class="status-circle bg-primary"></div>
                                                                <div class="d-inline-block">
                                                        ...
                                                        <td class="text-end"> <i class="fa fa-check-circle"></i>In
                                                            process</td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <div class="d-inline-block align-middle">
                                                                <img class="img-40 m-r-15 rounded-circle align-top"
                                                                    src="<?php echo e(asset('assets/images/avtar/3.jpg')); ?>" alt="">
                                                                <div class="status-circle bg-primary"></div>
                                                                <div class="d-inline-block">
