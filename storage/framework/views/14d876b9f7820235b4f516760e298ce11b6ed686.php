                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="amount" class="form-control btn-square" value="<?php echo e($edit_data->amount); ?>" id="exampleFormControlInput10" type="text" placeholder="amount">
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Cuba\resources\views/Package/edit.blade.php ENDPATH**/ ?>