                    ...
                    <div class="row">
                      ...
                      <div class="row">
                             <div class="col-md-12">
                                ...
                                <img src="<?php echo e(asset('storage/uploads/logo/' . $edit_data->image)); ?>" alt="image" style="width:80px; height:80px;">
                            <?php else: ?>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Cuba\resources\views/logomanager/edit.blade.php ENDPATH**/ ?>