      ...
      <ul class="nav-menus">
        ...
        <li class="profile-nav onhover-dropdown p-0 me-0">
          <div class="media profile-media">
            <img class="b-r-10" src="<?php echo e((!empty(Auth::user()->image))?
                asset('storage/uploads/cms/'.Auth::user()->image):asset('storage/uploads/No-image.jpg')); ?>" style="width:40px; height:40px;" alt="">
            <div class="media-body">
              <span><?php echo e(Auth::user()->name); ?></span>
              <p class="mb-0 font-roboto"><?php if(Auth::user()->type == '2'): ?>
                  User <?php else: ?> Admin <?php endif; ?><i class="middle fa fa-angle-down"></i></p>
            </div>
          </div>
