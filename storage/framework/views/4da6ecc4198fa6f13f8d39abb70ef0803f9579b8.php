    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                ...
                <form class="form theme-form"id="" action="<?php echo e(route("admin_update",$edit_data->id )); ?>" enctype="multipart/form-data" method="post">
                    <?php echo csrf_field(); ?>
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="password" class="form-control btn-square" value="<?php echo e($edit_data->password); ?>"id="exampleFormControlInput10" type="password" placeholder="Password">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="confirm_password" class="form-control btn-square" value="<?php echo e($edit_data->confirm_password); ?>"id="exampleFormControlInput10" type="password" placeholder="Confirm Password">
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Cuba\resources\views/admin/edit.blade.php ENDPATH**/ ?>