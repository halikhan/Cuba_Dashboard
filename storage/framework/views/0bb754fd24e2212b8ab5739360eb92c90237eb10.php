        ...
        <tr>
          <td>
            <table align="left" border="0" cellpadding="0" cellspacing="0" style="text-align: left;" width="100%">
              <tbody>
                <tr>
                  <td style="text-align: center;"><img src="<?php echo e(asset('assets/images/email-template/delivery-2.png')); ?>" alt="" style=";margin-bottom: 30px;"></td>
                </tr>
                <tr>
                  <td>
            ...
            <table cellpadding="0" cellspacing="0" border="0" align="left" style="width: 100%;margin-top: 10px;    margin-bottom: 10px;">
              <tbody>
                <tr>
                  ...
                  <td><img src="<?php echo e(asset('assets/images/email-template/space.jpg')); ?>" alt=" " height="25" width="30"></td>
                  <td style="background-color: #fafafa;border: 1px solid #ddd;padding: 15px;letter-spacing: 0.3px;width: 50%;">
            ...
            <table class="order-detail" border="0" cellpadding="0" cellspacing="0" align="left" style="width: 100%;    margin-bottom: 50px;">
              <tbody>
                ...
                <tr>
                  <td><img src="<?php echo e(asset('assets/images/email-template/4.png')); ?>" alt="" width="80"></td>
                ...
                <tr>
                  <td><img src="<?php echo e(asset('assets/images/email-template/1.png')); ?>" alt="" width="80"></td>
                  <td valign="top" style="padding-left: 15px;">
                    <h5 style="margin-top: 15px;">Three seater Wood Style sofa for Leavingroom </h5>
                  </td>
                  <td valign="top" style="padding-left: 15px;">
        ...
        <tr>
          <td style="padding: 30px;">
            ...
            <table class="footer-social-icon" border="0" cellpadding="0" cellspacing="0" align="center" style="margin-top:20px;">
              <tbody>
                <tr>
                  <td><a href="#"><img src="<?php echo e(asset('assets/images/email-template/facebook.png')); ?>" alt=""></a></td>
                  <td><a href="#"><img src="<?php echo e(asset('assets/images/email-template/youtube.png')); ?>" alt=""></a></td>
                  <td><a href="#"><img src="<?php echo e(asset('assets/images/email-template/twitter.png')); ?>" alt=""></a></td>
                  <td><a href="#"><img src="<?php echo e(asset('assets/images/email-template/gplus.png')); ?>" alt=""></a></td>
                  <td><a href="#"><img src="<?php echo e(asset('assets/images/email-template/linkedin.png')); ?>" alt=""></a></td>
                  <td><a href="#"><img src="<?php echo e(asset('assets/images/email-template/pinterest.png')); ?>" alt=""></a></td>
                </tr>
              </tbody>
            </table>
...
</html><?php /**PATH C:\xampp\htdocs\Cuba\resources\views/email-templates/ecommerce-templates.blade.php ENDPATH**/ ?>